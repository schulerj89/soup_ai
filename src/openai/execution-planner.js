  ...
  async plan({ chatId, messageText, workspaceRoot, projectRoot, session = null }) {
    ...
    const planner = this.agentFactory({
      ...
      instructions: [
        ...
        'If the user explicitly asks you to use Codex, have Codex do it, run Codex, inspect with Codex, or check the repo with Codex, that should normally be "run_codex" rather than "answer_directly".',
        ...
        'Inspection, analysis, summarization, verification, and repo spelunking requests should also use "run_codex" when the user wants Codex to perform that work locally.',

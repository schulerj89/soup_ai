...
const RawEnvSchema = z.object({
  ...
  OPENAI_TRANSCRIPTION_MODEL: z.string().trim().default('gpt-4o-mini-transcribe'),
  ...
  TELEGRAM_AUDIO_MAX_FILE_BYTES: z.coerce.number().int().min(1024).max(100 * 1024 * 1024).default(24 * 1024 * 1024),
...
export function loadConfig(options = {}) {
  ...
  return {
    ...
    openAiTranscriptionModel: raw.OPENAI_TRANSCRIPTION_MODEL,
    ...
    telegramAudioMaxFileBytes: raw.TELEGRAM_AUDIO_MAX_FILE_BYTES,
